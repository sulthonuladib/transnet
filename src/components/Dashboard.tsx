      ...
      <div class='card bg-base-200 shadow-xl transition-shadow hover:shadow-2xl'>
        <div class='card-body'>
          ...
          <p class='text-base-content/70'>
            Start a new withdrawal to any supported exchange
          </p>
...
export const Welcome: FC = () => {
  return (
    <div class='hero from-primary/10 to-secondary/10 min-h-[80vh] rounded-3xl bg-gradient-to-br'>
      <div class='hero-content text-center'>
        <div class='max-w-2xl'>
          <h1 class='text-base-content mb-8 text-6xl font-bold'>
            Welcome to <span class='text-primary'>TransNet</span>
          </h1>
          <p class='text-base-content/80 mb-8 text-xl'>
            Multi-exchange crypto withdrawal management system. Manage your
            withdrawals across multiple CEX platforms with ease.
          </p>
          ...
          <div class='mt-16 grid grid-cols-1 gap-6 md:grid-cols-3'>
            ...
            <div class='card bg-base-100 shadow-lg'>
              <div class='card-body text-center'>
                <div class='bg-secondary/10 mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
                ...
                <p class='text-base-content/70 text-sm'>
                  Quick withdrawals with real-time network status checking.
                </p>
              </div>
            </div>
            ...
            <div class='card bg-base-100 shadow-lg'>
              <div class='card-body text-center'>
                <div class='bg-accent/10 mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    fill='none'
                    viewBox='0 0 24 24'
                ...
                <p class='text-base-content/70 text-sm'>
                  Support for multiple CEX platforms in one place.
                </p>
              </div>
            </div>
          </div>

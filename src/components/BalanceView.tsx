...
export const BalanceView: FC<BalanceViewProps> = ({ balances, exchangeErrors, page = 1, totalPages = 1 }) => {
                  ...
                  <div class="space-y-1 text-sm">
                    ...
                    {balance.locked > 0 && (
                      <div class="flex justify-between">
                        ...
                        <span class="font-mono text-warning">{balance.locked.toFixed(8)}</span>
                      </div>
                    )}
                    
                    <div class="flex justify-between border-t pt-1">
                      <span class="font-semibold">Total:</span>
                      <span class="font-mono font-semibold">{balance.total.toFixed(8)}</span>
                    </div>
                    
                    {balance.usdValue && (
                      <div class="flex justify-between">
                        <span class="text-base-content/70">USD Value:</span>
                        <span class="font-mono text-success">${balance.usdValue.toFixed(2)}</span>
                      </div>
                    )}
                  </div>

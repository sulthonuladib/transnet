        ...
        <div class='card-body'>
          ...
          >
              ...
              >
                ...
                {coins.map(coin => {
                  const balance = balances.find(
                    b => b.coin === coin.symbol && b.exchange === coin.exchange
                  );
            ...
            <div class='form-control'>
              ...
              <div
                id='amount-error'
                class='label-text-alt text-error mt-1 hidden'
              ></div>
            </div>

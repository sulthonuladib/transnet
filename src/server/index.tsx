...
import { registerUser, authenticateUser, hashPassword, getUserOrganizations, createOrganization, switchUserOrganization } from '../auth/utils';
...
async function getOrganizationExchangeConfig(
	...
	return await db
		...
		.execute().then((res) => res.length > 0 ? res[0] : null);
}
